...
{
    /**
     * @return the type of link to match
     */
    ResourceType getLinkType();

    /**
     * @return the pattern to produce to match the link
     */
    Pattern getLinkReference();

    /**
     * @return the type of link to produce
     */
    ResourceType getTargetType();

    /**
     * @return the pattern to use to produce the link
     */
